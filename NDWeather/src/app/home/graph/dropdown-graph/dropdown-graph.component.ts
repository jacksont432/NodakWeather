...
@Component({
  selector: 'app-dropdown-graph',
  templateUrl: './dropdown-graph.component.html',
  styleUrls: ['./dropdown-graph.component.css']
})
export class DropdownGraphComponent implements OnInit {
